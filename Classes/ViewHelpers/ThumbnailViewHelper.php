...
class ThumbnailViewHelper extends AbstractTagBasedViewHelper
{
    ...
    public function initializeArguments(): void
    {
        ...
        if ((new Typo3Version())->getMajorVersion() < 13) {
            // Calls can be removed on dropping TYPO3 v12.4 support
            // @see https://docs.typo3.org/m/typo3/reference-coreapi/main/en-us/ApiOverview/Fluid/DevelopCustomViewhelper.html#php-this-registertagattribute
