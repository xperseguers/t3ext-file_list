...
:Release Notes:
	https://forge.typo3.org/projects/extension-file_list/wiki

:Git Repository:
	https://git.typo3.org/TYPO3CMS/Extensions/file_list.git
...
.. code-block:: bash
	...
	rm -rf file_list
	git clone https://git.typo3.org/TYPO3CMS/Extensions/file_list.git
	cd file_list
...
.. code-block:: bash
	...
	cd /path/to/site/typo3conf/ext/file_list
