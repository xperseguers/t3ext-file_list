...
if (t3lib_extMgm::isLoaded('indexed_search')) {
	...
	if (!$indexedSearchConfig['disableFrontendIndexing']) {
		$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['file_list']['extraItemMarkerHook'][] = 'EXT:file_list/Classes/Hooks/class.tx_filelist_indexedsearch.php:tx_filelist_indexedsearch';
	}
}
?>