...
if (t3lib_extMgm::isLoaded('indexed_search')) {
	...
	if (!$indexedSearchConfig['disableFrontendIndexing']) {
		$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['file_list']['extraItemMarkerHook'][] = 'EXT:lb_supported/Classes/Hooks/class.user_tx_filelist_indexedsearch.php:user_tx_filelist_indexedsearch->indexExternalFile';
	}
}
?>